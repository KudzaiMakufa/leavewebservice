<?php
class Controller_Leave extends Controller_Template
{
	...
	public function action_login()
	{
			...
			{		
					...
					foreach($result as $item)
					{
						...
						$login = "";
						if($item->isactivated == "0" && $item->verified == "1"){
							$login = "notactivated";
						}
		...
		$this->template->content = View::forge('leave/test', null);
	}
